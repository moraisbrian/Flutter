                      ...
                      children: <Widget>[
                        Observer(builder: (_) {
                          return CustomTextField(
                            ...
                            suffix: listStore.newTodoTitleIsEmpty
                                ? CustomIconButton(
                                    radius: 32,
                                    iconData: Icons.add,
                                    onTap: () {
                                      ...
                                      controller.clear();
                                      /*
                                      - Executa a função interna quando terminar de renderizar os widgets
                                      - Em versões anteriores era necessário adicionar nesta parte
